	      ...
	      <div class="jmslide-item">
	       <a href="<?php print $slide->link; ?>"> <img title="<?php print $slide->getThumbnail();?>" class="jmslide-img" src="<?php print $slide->getMainImage(); ?>"/></a>
	        <?php if ($jm_show_title || $jm_show_desc || $jm_show_readmore) { ?>
	          	<?php if ($jm_show_title) { ?><div class="slider_title"><h2><?php print $slide->title; ?></h2></div><?php } ?>
	            <?php if ($jm_show_desc) { ?><div class="slider_para"><?php print $slide->description; ?></div><?php } ?>
	            <?php if ($jm_show_readmore) { ?><div class="slider_link"><a href="<?php print $slide->link; ?>" class="btn"><?php print $jm_readmore_text; ?><i class="icon-chevron-right"></i></a></div><?php } ?>
	        <?php } ?>       
	      </div>
       <?php endif;?>
    <?php endforeach; ?>
